...
func init() {
	TengXunShipPin.Register()
}

// 考拉海淘,海外直采,7天无理由退货,售后无忧!考拉网放心的海淘网站!
var TengXunShipPin = &Spider{
	Name:        "腾讯视频",
	Description: "腾讯视频 [Auto Page] [https://news.qq.com/]",
	// Pausetime: 300,
	// Keyin:   KEYIN,
	// Limit:        LIMIT,
	EnableCookie: false,
	RuleTree: &RuleTree{
		Root: func(ctx *Context) {
			ctx.AddQueue(&request.Request{Url: "http://www.TengXunShipPin.com", Rule: "获取版块URL"})
		},
					...
					query.Find(".proinfo").Each(func(i int, s *goquery.Selection) {
						if url, ok := s.Find("a").Attr("href"); ok {
							ctx.AddQueue(&request.Request{
								Url:  "http://www.TengXunShipPin.com" + url,
								Rule: "商品详情",
